...
def render_disclaimer() -> None:
    ...
    Kept as compact HTML to avoid Streamlit/Markdown interpreting indented
    HTML paragraphs as a code block.
    """
    html = f"""
<div class="disclaimer-card">
  ...
  <p class="negative">It does <b>not</b> provide predictions, does <b>not</b> constitute an early warning system, and must <b>not</b> be used for operational, civil-protection, aviation, navigation, infrastructure, or safety decisions.</p>
  <hr style="opacity:0.2;">
  <p><b>Scientific resources (papers + full Python pipelines available):</b></p>
  <p>Seismic framework / monitoring implementation:<br><a href="{SEISMIC_DOI}" target="_blank">{SEISMIC_DOI}</a></p>
  <p>Volcanic framework / eruption-scale analysis (200+ events + monitoring mode):<br><a href="{VOLCANIC_DOI}" target="_blank">{VOLCANIC_DOI}</a></p>
  <p>Multistation coupling regimes / extreme-event structure:<br><a href="{EXTREME_EVENT_DOI}" target="_blank">{EXTREME_EVENT_DOI}</a></p>
</div>
"""
...
def render_header(zone_dirs: List[Path]) -> None:
    ...
    st.markdown(
        ...
        <div class="top-hero">
            <div>
                <div class="eyebrow">TAMC–FRANJAMAR MONITOR</div>
                <h1>Structure over amplitude · Multistation coherence monitor</h1>
                <p>
