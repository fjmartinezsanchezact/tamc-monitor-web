...
This monitor is developed independently in my spare time, driven by a genuine passion for science and a strong interest in understanding collective behavior in seismic networks.

It is built using a fully reproducible pipeline and continuously maintained and improved.

If you find it useful or interesting, you can support its development.  
This project exists thanks to many hours of personal work, curiosity, and dedication..
  </div>
</div>
            """,
            unsafe_allow_html=True,
